...
#if IS_ENABLED(CONFIG_ST_LSM6DS3H_IIO_EXT0_AKM09911)
...
#if IS_ENABLED(CONFIG_ST_LSM6DS3H_IIO_EXT0_AKM09912)
...
#if IS_ENABLED(CONFIG_ST_LSM6DS3H_IIO_EXT0_AKM09916)
#define ST_LSM6DS3H_EXT0_ADDR			0x0c
...
#if IS_ENABLED(CONFIG_ST_LSM6DS3H_IIO_EXT0_LPS22HB)
...
#if IS_ENABLED(CONFIG_ST_LSM6DS3H_IIO_EXT0_LIS3MDL) || \
    IS_ENABLED(CONFIG_ST_LSM6DS3H_IIO_EXT0_AKM09912) || \
    IS_ENABLED(CONFIG_ST_LSM6DS3H_IIO_EXT0_AKM09916) || \
    IS_ENABLED(CONFIG_ST_LSM6DS3H_IIO_EXT0_AKM09911)
			...
			bool transfer_lock, bool read_status_end, u8 offset)
{
	...
	err = st_lsm6ds3h_read_register(cdata, ST_LSM6DS3H_SLV0_OUT_ADDR +
...
static int st_lsm6ds3h_i2c_master_allocate_trigger(struct lsm6ds3h_data *cdata)
{
	int err;
...
#if IS_ENABLED(CONFIG_ST_LSM6DS3H_ENABLE_INTERNAL_PULLUP)
