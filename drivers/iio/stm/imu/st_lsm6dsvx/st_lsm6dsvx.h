...
#define ST_LSM6DSVX_OP_MODE_MASK		GENMASK(6, 4)
#define ST_LSM6DSVX_OP_MODE_XL_HP_VAL		0x00
#define ST_LSM6DSVX_OP_MODE_XL_ODR_TRIG_VAL	0x03
...
#define ST_LSM6DSVX_FS_G_MASK			GENMASK(3, 0)
...
#define ST_LSM6DSVX_FS_XL_MASK			GENMASK(1, 0)
...
#define ST_LSM6DSVX_WAKE_UP_SRC_FF_IA_MASK	BIT(5)
#define ST_LSM6DSVX_WAKE_UP_SRC_WU_IA_MASK	BIT(3)
#define ST_LSM6DSVX_X_WU_MASK			BIT(2)
#define ST_LSM6DSVX_Y_WU_MASK			BIT(1)
#define ST_LSM6DSVX_Z_WU_MASK			BIT(0)

#define ST_LSM6DSVX_REG_TAP_SRC_ADDR		0x46
#define ST_LSM6DSVX_Z_TAP_MASK			BIT(0)
#define ST_LSM6DSVX_Y_TAP_MASK			BIT(1)
#define ST_LSM6DSVX_X_TAP_MASK			BIT(2)
#define ST_LSM6DSVX_TAP_SIGN_MASK		BIT(3)
#define ST_LSM6DSVX_DOUBLE_TAP_IA_MASK		BIT(4)
#define ST_LSM6DSVX_SINGLE_TAP_IA_MASK		BIT(5)
#define ST_LSM6DSVX_XYZ_TAP_IA_MASK		GENMASK(2, 0)

#define ST_LSM6DSVX_REG_D6D_SRC_ADDR		0x47
#define ST_LSM6DSVX_D6D_EVENT_MASK		GENMASK(5, 0)
#define ST_LSM6DSVX_D6D_SRC_D6D_IA_MASK		BIT(6)
#define ST_LSM6DSVX_ZH_MASK			BIT(5)
#define ST_LSM6DSVX_ZL_MASK			BIT(4)
#define ST_LSM6DSVX_YH_MASK			BIT(3)
#define ST_LSM6DSVX_YL_MASK			BIT(2)
#define ST_LSM6DSVX_XH_MASK			BIT(1)
#define ST_LSM6DSVX_XL_MASK			BIT(0)
...
#define ST_LSM6DSVX_TAP_Z_EN_MASK		BIT(1)
#define ST_LSM6DSVX_TAP_Y_EN_MASK		BIT(2)
#define ST_LSM6DSVX_TAP_X_EN_MASK		BIT(3)
#define ST_LSM6DSVX_TAP_EN_MASK			GENMASK(3, 1)
#define ST_LSM6DSVX_TAP_SLOPE_FDS_MASK		BIT(4)
...
#define ST_LSM6DSVX_TS_DELTA_NS			21701ULL
#define ST_LSM6DSVX_TS_CAL_COEFF		28212
...
#define ST_LSM6DSVX_FAST_TO_DEFAULT		(10)
...
static const struct iio_event_spec st_lsm6dsvx_wakeup_event = {
	.type = IIO_EV_TYPE_THRESH,
	.dir = IIO_EV_DIR_RISING,
...
static const struct iio_event_spec st_lsm6dsvx_freefall_event = {
	.type = IIO_EV_TYPE_THRESH,
...
static const struct iio_event_spec st_lsm6dsvx_6D_event = {
...
static const struct iio_event_spec st_lsm6dsvx_tap_event = {
...
static const struct iio_event_spec st_lsm6dsvx_dtap_event = {
	.type = IIO_EV_TYPE_GESTURE,
...
enum st_lsm6dsvx_suspend_resume_register {
	ST_LSM6DSVX_IF_CFG_REG = 0,
	...
	ST_LSM6DSVX_SUSPEND_RESUME_REGS,
};

enum st_lsm6dsvx_page_sel_register {
	FUNC_CFG_ACCESS_0 = 0,
	FUNC_CFG_ACCESS_SHUB_REG,
	FUNC_CFG_ACCESS_FUNC_CFG,
};

struct st_lsm6dsvx_suspend_resume_entry {
	u8 page;
	u8 addr;
	u8 val;
	u8 mask;
...
/* this is the minimal ODR for event sensors and dependencies (AN5763) */
#define ST_LSM6DSVX_MIN_ODR_IN_WAKEUP			30
#define ST_LSM6DSVX_MIN_ODR_IN_FREEFALL			30
#define ST_LSM6DSVX_MIN_ODR_IN_6D			30
#define ST_LSM6DSVX_MIN_ODR_IN_EMB_FUNC			30
#define ST_LSM6DSVX_MIN_ODR_IN_TAP			480
#define ST_LSM6DSVX_MIN_ODR_IN_DTAP			480
...
static inline int st_lsm6dsvx_manipulate_bit(int int_reg, int irq_mask, int en)
{
