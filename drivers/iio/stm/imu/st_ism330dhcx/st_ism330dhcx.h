...
#define ST_ISM330DHCX_REG_CTRL6_C_ADDR		0x15
#define ST_ISM330DHCX_REG_XL_HM_MODE_MASK	BIT(4)
#define ST_ISM330DHCX_REG_FTYPE_MASK		GENMASK(2, 0)

#define ST_ISM330DHCX_REG_CTRL7_G_ADDR		0x16
#define ST_ISM330DHCX_REG_G_HM_MODE_MASK	BIT(7)
...
#define ST_ISM330DHCX_FSM_STATUS_A_MAINPAGE	0x36
#define ST_ISM330DHCX_FSM_STATUS_B_MAINPAGE	0x37
#define ST_ISM330DHCX_MLC_STATUS_MAINPAGE	0x38
...
/* embedded registers */
#define ST_ISM330DHCX_PAGE_SEL_ADDR		0x02
#define ST_ISM330DHCX_PAGE_SEL_MASK		GENMASK(7, 4)
...
#define ST_ISM330DHCX_EMB_FUNC_EN_B_ADDR	0x05
#define ST_ISM330DHCX_FSM_EN_MASK		BIT(0)
#define ST_ISM330DHCX_MLC_EN_MASK		BIT(4)

#define ST_ISM330DHCX_REG_EMB_FUNC_INT1_ADDR	0x0a
#define ST_ISM330DHCX_FSM_INT1_A_ADDR		0x0b
#define ST_ISM330DHCX_FSM_INT1_B_ADDR		0x0c
#define ST_ISM330DHCX_MLC_INT1_ADDR		0x0d
...
#define ST_ISM330DHCX_FSM_INT2_A_ADDR		0x0f
#define ST_ISM330DHCX_FSM_INT2_B_ADDR		0x10
#define ST_ISM330DHCX_MLC_INT2_ADDR		0x11

#define ST_ISM330DHCX_REG_MLC_STATUS_ADDR	0x15

#define ST_ISM330DHCX_PAGE_RW_ADDR		0x17
#define ST_ISM330DHCX_REG_EMB_FUNC_LIR_MASK	BIT(7)
#define ST_ISM330DHCX_REG_PAGE_WRITE_MASK	BIT(6)
#define ST_ISM330DHCX_REG_PAGE_READ_MASK	BIT(5)

#define ST_ISM330DHCX_EMB_FUNC_FIFO_CFG_ADDR	0x44
#define ST_ISM330DHCX_PEDO_FIFO_EN_MASK		BIT(6)

#define ST_ISM330DHCX_FSM_ENABLE_A_ADDR		0x46
#define ST_ISM330DHCX_FSM_ENABLE_B_ADDR		0x47

#define ST_ISM330DHCX_FSM_OUTS1_ADDR		0x4c
...
#define ST_ISM330DHCX_REG_EMB_FUNC_INIT_B_ADDR	0x67
#define ST_ISM330DHCX_FSM_INIT_MASK		BIT(0)
#define ST_ISM330DHCX_MLC_INIT_MASK		BIT(4)

#define ST_ISM330DHCX_REG_MLC0_SRC_ADDR		0x70
...
enum st_ism330dhcx_fsm_mlc_enable_id {
	ST_ISM330DHCX_MLC_FSM_DISABLED = 0,
	ST_ISM330DHCX_MLC_ENABLED = BIT(0),
	ST_ISM330DHCX_FSM_ENABLED = BIT(1),
};
 ...
 */
struct st_ism330dhcx_mlc_config_t {
	u8 mlc_int_mask;
	...
	enum st_ism330dhcx_fsm_mlc_enable_id status;
};
...
enum st_ism330dhcx_sensor_id {
	...
	ST_ISM330DHCX_ID_MLC_0,
	ST_ISM330DHCX_ID_MLC_1,
	ST_ISM330DHCX_ID_MLC_2,
	ST_ISM330DHCX_ID_MLC_3,
	ST_ISM330DHCX_ID_MLC_4,
	ST_ISM330DHCX_ID_MLC_5,
	ST_ISM330DHCX_ID_MLC_6,
	ST_ISM330DHCX_ID_MLC_7,
	ST_ISM330DHCX_ID_FSM_0,
	ST_ISM330DHCX_ID_FSM_1,
	ST_ISM330DHCX_ID_FSM_2,
	ST_ISM330DHCX_ID_FSM_3,
	ST_ISM330DHCX_ID_FSM_4,
	ST_ISM330DHCX_ID_FSM_5,
	ST_ISM330DHCX_ID_FSM_6,
	ST_ISM330DHCX_ID_FSM_7,
	ST_ISM330DHCX_ID_FSM_8,
	ST_ISM330DHCX_ID_FSM_9,
	ST_ISM330DHCX_ID_FSM_10,
	ST_ISM330DHCX_ID_FSM_11,
	ST_ISM330DHCX_ID_FSM_12,
	ST_ISM330DHCX_ID_FSM_13,
	ST_ISM330DHCX_ID_FSM_14,
	ST_ISM330DHCX_ID_FSM_15,
...
static const enum st_ism330dhcx_sensor_id st_ism330dhcx_mlc_sensor_list[] = {
	[0] = ST_ISM330DHCX_ID_MLC_0,
	[1] = ST_ISM330DHCX_ID_MLC_1,
	[2] = ST_ISM330DHCX_ID_MLC_2,
	[3] = ST_ISM330DHCX_ID_MLC_3,
	[4] = ST_ISM330DHCX_ID_MLC_4,
	[5] = ST_ISM330DHCX_ID_MLC_5,
	[6] = ST_ISM330DHCX_ID_MLC_6,
	[7] = ST_ISM330DHCX_ID_MLC_7,
};

static const enum st_ism330dhcx_sensor_id st_ism330dhcx_fsm_sensor_list[] = {
	[0] = ST_ISM330DHCX_ID_FSM_0,
	[1] = ST_ISM330DHCX_ID_FSM_1,
	[2] = ST_ISM330DHCX_ID_FSM_2,
	[3] = ST_ISM330DHCX_ID_FSM_3,
	[4] = ST_ISM330DHCX_ID_FSM_4,
	[5] = ST_ISM330DHCX_ID_FSM_5,
	[6] = ST_ISM330DHCX_ID_FSM_6,
	[7] = ST_ISM330DHCX_ID_FSM_7,
	[8] = ST_ISM330DHCX_ID_FSM_8,
	[9] = ST_ISM330DHCX_ID_FSM_9,
	[10] = ST_ISM330DHCX_ID_FSM_10,
	[11] = ST_ISM330DHCX_ID_FSM_11,
	[12] = ST_ISM330DHCX_ID_FSM_12,
	[13] = ST_ISM330DHCX_ID_FSM_13,
	[14] = ST_ISM330DHCX_ID_FSM_14,
	[15] = ST_ISM330DHCX_ID_FSM_15,
};


#define ST_ISM330DHCX_ID_ALL_FSM_MLC (BIT_ULL(ST_ISM330DHCX_ID_MLC_0)       | \
				      BIT_ULL(ST_ISM330DHCX_ID_MLC_1)       | \
				      BIT_ULL(ST_ISM330DHCX_ID_MLC_2)       | \
				      BIT_ULL(ST_ISM330DHCX_ID_MLC_3)       | \
				      BIT_ULL(ST_ISM330DHCX_ID_MLC_4)       | \
				      BIT_ULL(ST_ISM330DHCX_ID_MLC_5)       | \
				      BIT_ULL(ST_ISM330DHCX_ID_MLC_6)       | \
				      BIT_ULL(ST_ISM330DHCX_ID_MLC_7)       | \
				      BIT_ULL(ST_ISM330DHCX_ID_FSM_0)       | \
				      BIT_ULL(ST_ISM330DHCX_ID_FSM_1)       | \
				      BIT_ULL(ST_ISM330DHCX_ID_FSM_2)       | \
				      BIT_ULL(ST_ISM330DHCX_ID_FSM_3)       | \
				      BIT_ULL(ST_ISM330DHCX_ID_FSM_4)       | \
				      BIT_ULL(ST_ISM330DHCX_ID_FSM_5)       | \
				      BIT_ULL(ST_ISM330DHCX_ID_FSM_6)       | \
				      BIT_ULL(ST_ISM330DHCX_ID_FSM_7)       | \
				      BIT_ULL(ST_ISM330DHCX_ID_FSM_8)       | \
				      BIT_ULL(ST_ISM330DHCX_ID_FSM_9)       | \
				      BIT_ULL(ST_ISM330DHCX_ID_FSM_10)      | \
				      BIT_ULL(ST_ISM330DHCX_ID_FSM_11)      | \
				      BIT_ULL(ST_ISM330DHCX_ID_FSM_12)      | \
				      BIT_ULL(ST_ISM330DHCX_ID_FSM_13)      | \
				      BIT_ULL(ST_ISM330DHCX_ID_FSM_14)      | \
				      BIT_ULL(ST_ISM330DHCX_ID_FSM_15))

/*
 * HW devices that can wakeup the target
 */
#define ST_ISM330DHCX_WAKE_UP_SENSORS (BIT_ULL(ST_ISM330DHCX_ID_GYRO)       | \
				       BIT_ULL(ST_ISM330DHCX_ID_ACC)        | \
				       ST_ISM330DHCX_ID_ALL_FSM_MLC)
...
struct st_ism330dhcx_hw {
	...
	struct st_ism330dhcx_mlc_config_t *mlc_config;
	bool preload_mlc;
};
...
{
	return hw->enable_mask & (BIT_ULL(ST_ISM330DHCX_ID_GYRO)	|
				  BIT_ULL(ST_ISM330DHCX_ID_ACC)		|
...
static inline int
st_ism330dhcx_read_page_locked(struct st_ism330dhcx_hw *hw, unsigned int addr,
...
static inline int
st_ism330dhcx_write_page_locked(struct st_ism330dhcx_hw *hw,
				unsigned int addr,
...
static inline int
st_ism330dhcx_update_page_bits_locked(struct st_ism330dhcx_hw *hw,
				      unsigned int addr,
				      unsigned int mask,
				      unsigned int val)
{
...
static inline
bool st_ism330dhcx_fsm_running(struct st_ism330dhcx_hw *hw)
{
	return hw->enable_mask &
	       GENMASK_ULL(ST_ISM330DHCX_ID_FSM_15,
			   ST_ISM330DHCX_ID_FSM_0);
}

static inline
bool st_ism330dhcx_mlc_running(struct st_ism330dhcx_hw *hw)
{
	return hw->enable_mask &
	       GENMASK_ULL(ST_ISM330DHCX_ID_MLC_7,
			   ST_ISM330DHCX_ID_MLC_0);
}
...
int st_ism330dhcx_of_get_pin(struct st_ism330dhcx_hw *hw, int *pin);
...
int st_ism330dhcx_set_odr(struct st_ism330dhcx_sensor *sensor, int req_odr,
			  int req_uodr);
int st_ism330dhcx_get_odr_from_reg(enum st_ism330dhcx_sensor_id id,
