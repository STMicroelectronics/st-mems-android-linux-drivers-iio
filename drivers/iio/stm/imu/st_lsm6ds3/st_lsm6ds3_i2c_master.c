...
#if IS_ENABLED(CONFIG_ST_LSM6DS3_IIO_EXT0_AKM09911)
...
#if IS_ENABLED(CONFIG_ST_LSM6DS3_IIO_EXT0_AKM09912)
...
#if IS_ENABLED(CONFIG_ST_LSM6DS3_IIO_EXT0_AKM09916)
#define ST_LSM6DS3_EXT0_ADDR			0x0c
...
#if IS_ENABLED(CONFIG_ST_LSM6DS3_IIO_EXT0_LPS22HB)
...
#if IS_ENABLED(CONFIG_ST_LSM6DS3_IIO_EXT0_LIS2MDL)
...
#if IS_ENABLED(CONFIG_ST_LSM6DS3_IIO_EXT0_LIS3MDL) || \
    IS_ENABLED(CONFIG_ST_LSM6DS3_IIO_EXT0_AKM09912) || \
    IS_ENABLED(CONFIG_ST_LSM6DS3_IIO_EXT0_AKM09916) || \
    IS_ENABLED(CONFIG_ST_LSM6DS3_IIO_EXT0_AKM09911)
#define ST_LSM6DS3_EXT0_HAS_SELFTEST		1
    ...
    IS_ENABLED(CONFIG_ST_LSM6DS3_IIO_EXT0_AKM09916) || \
    IS_ENABLED(CONFIG_ST_LSM6DS3_IIO_EXT0_AKM09911) || \
    IS_ENABLED(CONFIG_ST_LSM6DS3_IIO_EXT0_LPS22HB)
			...
			bool transfer_lock, bool read_status_end, u8 offset)
{
	...
	err = st_lsm6ds3_read_register(cdata, ST_LSM6DS3_SLV0_OUT_ADDR +
...
static int st_lsm6ds3_i2c_master_allocate_trigger(struct lsm6ds3_data *cdata)
{
	int err;
...
int st_lsm6ds3_i2c_master_probe(struct lsm6ds3_data *cdata)
{
...
#if IS_ENABLED(CONFIG_ST_LSM6DS3_ENABLE_INTERNAL_PULLUP)
	...
	err = st_lsm6ds3_write_data_with_mask(cdata,
					      ...
					      ST_LSM6DS3_FUNC_MAX_RATE_MASK, 1,
					      true);
	if (err < 0)
		return err;
